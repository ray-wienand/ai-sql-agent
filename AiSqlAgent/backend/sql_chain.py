...
template = """
You are a SQL database expert. Based on the schema provided, and the message history, 
your role is to write a SQL query that answers the question/request.Always use the full 
financial amount for analysis. But when you provide the the results the amounts should 
only have two decimals.
