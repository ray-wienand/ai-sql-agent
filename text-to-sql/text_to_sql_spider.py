...
# 2. Import Data
# Automatically load the question / instruction and schema for the database
# We will be able to know if the LLM is able to convert the text to a sql query based on the database schema
gym = SpiderEnv()
db_id = ('data/northwind.db')
...
# # 3. Create Agents
# # Check to see if any tools are running
...
# {question}
# Give me a list of all the products
# """
